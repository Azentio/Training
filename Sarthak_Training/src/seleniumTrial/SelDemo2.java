...
public class SelDemo2 
{
	...
	{
		System.setProperty("webdriver.chrome.driver","C:\\Users\\sarthak.gaidhani\\git\\repository\\Sarthak_Training\\driver\\chromedriver.exe");
...
WebElement minSlide = driver.findElement(By.xpath("//a[@aria-labelledby=\"price-min-label\"]"));
